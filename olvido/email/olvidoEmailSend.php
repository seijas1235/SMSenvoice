            ...
            <div class="row d-flex justify-content-center align-items-center" style="height: 100%;">
                <div class="col-9 col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text">Hemos enviado un link a su correo para que asi pueda cambiar su contraseña</p>
                        </div>
                        <div class="card-footer">
                            <a href="../../login/login.php"><button class="btn btn-primary">Volver al login</button></a>
                        </div>
                    </div>
                </div>
            </div>
