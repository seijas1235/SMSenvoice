    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="listasContactos.php"><i data-feather="phone"></i><span class="menu-title text-truncate">Lista de contactos</span></a>
                </li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form" action="https://sandbox.checkout.payulatam.com/ppp-web-gateway-payu/" method="POST">
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <div class="input-group input-group-merge mb-2">
                                                        ...
                                                        <input type="text" id="recarga-amount" autocomplete="off" autofocus class="form-control form-control-lg" placeholder="25000" min='25000' name="recarga" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="parameters-checkout">
                                            </div>
                                            <div class="col-12">
                                                <button type="button" class="btn btn-primary mr-1" id="checkoutButton">Pagar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
