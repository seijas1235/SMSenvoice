...
if (!empty($_POST['sub'])) {
    ...
    $stmt = $conn->prepare('SELECT ID, nombre_usuario, email, active, password FROM usuarios WHERE email=:email OR nombre_usuario=:username');
    ...
    if ($results != false) {
        ...
        if (!password_verify($password, $results['password'])) {
            ...
            if ($results['active'] == 0) {
                $message = 'Su cuenta no ha sido activada, por favor active su cuenta';
            } else {
                                ...
                                <form class="auth-login-form mt-2" action="login.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="../olvido/password/olvidoPassword.php">
