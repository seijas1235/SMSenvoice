...
if (isset($_GET['id'])) {
    ...
    $sql = 'SELECT id_contacto, cod_pais, nombre_contacto, celular  FROM contactos WHERE lista=:idLista AND usuario=:user_id';
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Contactos de la lista
                                    </li>
                                </ol>
                            </div>
                        </div>
                                    ...
                                    <table class="dt-complex-header table table-bordered table-responsive">
                                        ...
                                        <tbody>
                                            <?php foreach ($results as $result) : ?>
                                                <tr>
                                                    <td><?= $result['nombre_contacto']; ?></td>
                                                    <td><?= $result['cod_pais']; ?></td>
                                                    <td><?= $result['celular']; ?></td>
                                                    <td>
                                                        <a href="eliminarContactos.php?id=<?= $result['id_contacto']; ?>&lis=<?= $idLista; ?>">
                                                            <i data-feather="trash"></i>
                                                        </a>
                                                        <a href="editarContactos.php?id=<?= $result['id_contacto']; ?>&lis=<?= $idLista; ?>">
