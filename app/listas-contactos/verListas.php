...
$sql = 'SELECT id_tabla, nombre_tabla_contactos, fecha FROM lista_contactos WHERE usuario=:user_id';
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Ver
                                    </li>
                                </ol>
                            </div>
                        </div>
                                    ...
                                    <table class="dt-complex-header table table-bordered table-responsive">
                                        ...
                                        <tbody>
                                            <?php foreach ($results as $result) : ?>
                                                <tr>
                                                    <td><?= $result['nombre_tabla_contactos']; ?></td>
                                                    <td>0</td>
                                                    <td><?= $result['fecha']; ?></td>
                                                    <td>
                                                        <a href="eliminarLista.php?id=<?= $result['id_tabla']; ?>" class="">
                                                            <i data-feather="trash"></i>
                                                        </a>
                                                        <a href="editarLista.php?id=<?= $result['id_tabla']; ?>" class="">
                                                            <i data-feather="edit"></i>
                                                        </a>
                                                        <a href="contactos/verContactos.php?id=<?= $result['id_tabla']; ?>" class="">
