...
if (!empty($_POST['sub']) and !empty($_POST['email'])) {
    $sql = "SELECT email FROM usuarios WHERE email=:email AND active=0";
    ...
    if ($result != false) {
        ...
        $sql = 'UPDATE usuarios SET hash=:hash WHERE email=:email AND active=0';
        $stmt = $conn->prepare($sql);
        ...
        $message = 'El usuario ya esta activado o no existe';
    }
}
function reenviarEmail($email, $hash)
{
    try {
        ...
        $mail->Username = 'adrianjaa10142002@gmail.com';

        //Password to use for SMTP authentication
        $mail->Password = '12099412$10$14$2002$';
        ...
        $mail->send();
        header('Location: ../registro/emailSend.php');
    } catch (Exception $e) {
        global $message;
...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static " data-open="click" data-menu="vertical-menu-modern" data-col="">
        ...
        <!-- END: Custom modal -->';
            ...
            <div class="row d-flex justify-content-center align-items-center" style="height: 100%; width: 100%; margin: 0;">
                <div class="col-9 col-md-4">
                    <div class="card">
                        <form action="reenviar.php" method="POST">
                            <div class="card-header">
                                <h4 class="card-title">Reenviar correo de verificación</h4>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary mb-1">Reenviar</button>
    ...
    <!-- BEGIN: Page JS-->
    <script src="../assets/js/reenviar.js"></script>
    <!-- END: Page JS-->
